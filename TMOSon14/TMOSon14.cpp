...
{ 
    ...
    base_channels.push_back(basePhase2Chan[2]);
    base_channels.push_back(basePhase2Chan[1]);
    base_channels.push_back(basePhase2Chan[0]);
	...
	*/
	...
	std::vector<cv::Mat> ST = optimizationWithOases(height, width, sumOfDetail, r1Layer, r2Layer, base_channels, detail);
